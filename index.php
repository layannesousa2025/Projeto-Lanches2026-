...
<body>
    <header class="navbar">
        <div class="logo">
            <img src="img/logo.jpg" alt="Hero Burgers Logo" class="brand-logo">
    ...
    <div id="welcomeOverlay" class="welcome-overlay">
        <div class="welcome-content">
            <div class="welcome-logo">
                <img src="img/logo.jpg" alt="Logo" class="welcome-brand-logo" style="height: 60px; margin-bottom: 15px;">
